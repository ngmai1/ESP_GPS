...
const char* host = "http://192.168.8.250";
const int port = 3000;
...
void event_handle(const char * payload, size_t length) {
...
void loop() {
  ...
  // socket.loop();
  // socket.emit("message_esp32", "Hello from ESP32");
  // delay(2000);

  //place your code to process RFID here
